...
namespace AgenciaMareSol.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cidade,Estado,Preco")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cidade,Estado,Preco")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
